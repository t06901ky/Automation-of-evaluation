...
# VALANCE の Values
以下 3 つの Value に基づいて、評価対象者の行動を観察し value_comment を生成すること。

## Fairness
誰もが尊重され、公平に評価される組織でありたい。立場や背景に関わらず、機会が与えられ、成果や挑戦が正しく認められる環境をつくる。互いの違いを力に変え、信頼と透明性を基盤としたチームで、真にフェアな社会を体現していきます。

## Independence
常識・慣習に縛られず、自分たちの信念に基づいて挑戦を続ける反骨精神を持つ組織でありたい。仲間と共に既存の枠組みに挑み、信じる未来を実現する。

## Resilience
変化や逆境を恐れず、しなやかに乗り越える力＝Resilienceを持ち続けたい。挑戦の過程で起こる不確実性を、チームの結束と学びによってチャンスへと変えていきます。
